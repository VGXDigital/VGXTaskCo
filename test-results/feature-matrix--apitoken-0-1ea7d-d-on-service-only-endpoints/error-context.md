...
- Name: feature-matrix.spec.ts >> [apitoken-008] User-scope token rejected on service-only endpoints
- Location: tests/e2e/feature-matrix.spec.ts:256:7

# Error details

```
Error: [apitoken-008] User-scope token on service endpoint expected 403
