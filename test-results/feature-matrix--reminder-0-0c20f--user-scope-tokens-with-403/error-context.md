...
- Name: feature-matrix.spec.ts >> [reminder-003] Reminder endpoints reject user-scope tokens with 403
- Location: tests/e2e/feature-matrix.spec.ts:256:7

# Error details

```
Error: [reminder-003] User-scope token on reminders expected 403
