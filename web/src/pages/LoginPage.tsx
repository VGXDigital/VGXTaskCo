      ...
      <div className="w-full max-w-sm rounded-xl bg-white p-8 shadow-sm ring-1 ring-gray-200 dark:bg-gray-900 dark:ring-gray-800">
        ...
        <div className="mb-6 flex flex-col items-center gap-3">
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">Task management for teams</p>
          </div>
          {/* VGX gradient accent line */}
          <div className="h-1 w-16 rounded-full vgx-gradient" />
        </div>
        ...
        <div className="relative mb-6">
          ...
          <div className="relative flex justify-center text-xs">
            <span className="bg-white px-2 text-gray-400 dark:bg-gray-900 dark:text-gray-500">or continue with email</span>
          </div>
        </div>
